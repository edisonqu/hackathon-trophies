...
export default function LoginPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const userResponse = await fetch(`https://hackathon-trophies.onrender.com/user/${username}`);
            if (!userResponse.ok) {
            ...
            const projectResponse = await fetch(`https://hackathon-trophies.onrender.com/project-list/${username}`);
            ...
            <div className="flex min-h-screen flex-1 flex-col justify-center px-6 py-12 lg:px-8 bg-cream">
                ...
                <div className="mt-5 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            <p className="">
                                Please enter your Devpost username.
                            </p>
                            <div className="mt-2">
                                <input
                                    required
